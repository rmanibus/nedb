...
describe("Model", () => {
  describe("Serialization, deserialization", () => {
    ...
    it("Can serialize string fields with a new line without breaking the DB", (done) => {
      let db1;
      let db2;
  ...
  describe("Compound Comparing Things", () => {
    it("undefined is the smallest", () => {
      const otherStuff = [
        { a: 0, b: 0 },
        { a: 0, b: 1 },
    ...
    it("Then properties should be compared, returning the first non-zero result, or zero", () => {
      const examples = [
        { a: 0, b: 0 },
        { a: 0, b: 1 },
        { a: 1, b: 0 },
      ...
      const less = (a, b) => {
        assert.equal(
          model.compoundCompareThings(fields)(examples[a], examples[b]),
          -1
        );
      };
      const more = (a, b) => {
        assert.equal(
          model.compoundCompareThings(fields)(examples[b], examples[a]),
          1
        );
      };
      ...
      examples.forEach((example) => {
        assert.equal(
          model.compoundCompareThings(fields)(example, model.deepCopy(example)),
          0
        );
      });
    });
