...
(function () {
  ...
  define("promise/polyfill", ["./promise", "./utils", "exports"], function (
    __dependency1__,
    __dependency2__,
    __exports__
  ) {
...
(function webpackUniversalModuleDefinition(root, factory) {
  ...
  else if (typeof exports === "object") exports["localforage"] = factory();
            ...
            var promise = self.ready().then(function () {
              ...
              for (var i = 0; i < length; i++) {
                if (localStorage.key(i).indexOf(dbInfo.keyPrefix) === 0) {
                  keys.push(
                    localStorage.key(i).substring(dbInfo.keyPrefix.length)
                  );
                }
              }
