(function () {
  ...
  require.register("browser/diff.js", function (module, exports, require) {}); // module: browser/diff.js
  ...
  require.register("reporters/html.js", function (module, exports, require) {
    ...
    function HTML(runner, root) {
      ...
      on(passesLink, "click", function () {
        ...
        report.className =
          report.className.replace(/fail|pass/g, "") + className;
      });
      ...
      runner.on("test end", function (test) {
        ...
        if ("passed" == test.state) {
          var el = fragment(
            '<li class="test pass %e"><h2>%e<span class="duration">%ems</span></h2></li>',
            test.speed,
            test.title,
            test.duration
          );
        ...
        if (!test.pending) {
          ...
          on(h2, "click", function () {
            pre.style.display =
              "none" == pre.style.display ? "inline-block" : "none";
          });
  ...
  require.register("reporters/spec.js", function (module, exports, require) {
    ...
    function Spec(runner) {
      ...
      runner.on("pass", function (test) {
        if ("fast" == test.speed) {
          var fmt =
            indent() + color("checkmark", "  ✓") + color("pass", " %s ");
          cursor.CR();
          console.log(fmt, test.title);
        } else {
          var fmt =
