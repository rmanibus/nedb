(function (e) {
  if ("function" == typeof bootstrap) bootstrap("nedb", e);
    ...
    "undefined" != typeof window ? (window.Nedb = e()) : (global.Nedb = e());
})(function () {
  ...
  return (function (e, t, n) {
  ...
  })(
    {
      ...
      7: [
        function (require, module, exports) {
           ...
           * @api private
           */
          Datastore.prototype._insertMultipleDocsInCache = function (
            preparedDocs
          ) {
          ...
          Datastore.prototype.count = function (query, callback) {
            var cursor = new Cursor(this, query, function (
              err,
              docs,
              callback
            ) {
           ...
           */
          Datastore.prototype._update = function (
            query,
            updateQuery,
            options,
            cb
      ...
      8: [
        ...
        { __browserify_process: 4, async: 13 },
      ],
      9: [
        function (require, module, exports) {
        ...
        { "./model": 10, "binary-search-tree": 14, underscore: 19, util: 3 },
      ],
      10: [
        function (require, module, exports) {
          /**
          ...
          function getDotValue(obj, field) {
            ...
            if (util.isArray(obj[fieldParts[0]])) {
              ...
              for (i = 0; i < obj[fieldParts[0]].length; i += 1) {
                objs.push(
                  getDotValue(obj[fieldParts[0]][i], fieldParts.slice(1))
                );
              }
              return objs;
            } else {
          ...
          function areThingsEqual(a, b) {
            ...
            if (util.isDate(a) || util.isDate(b)) {
              return (
                util.isDate(a) && util.isDate(b) && a.getTime() === b.getTime()
              );
            }
        ...
        function (require, module, exports) {
          ...
          function Persistence(options) {
            ...
            if (this.filename && options.nodeWebkitAppName) {
              ...
              console.log(
                "WARNING: The nodeWebkitAppName option is deprecated"
              );
              console.log(
              ...
              console.log(
                "See https://github.com/rogerwang/node-webkit/issues/500"
              );
              console.log(
                "=================================================================="
              );
                        ...
                        function (err) {
                          storage.readFile(
                            ...
                            function (err, rawData) {
                              ...
                              Object.keys(treatedData.indexes).forEach(
                                function (key) {
                                  self.db.indexes[key] = new Index(
    ...
    async.error = _console_fn('error');*/
      ...
      15: [
        function (require, module, exports) {
          ...
          function _AVLTree(options) {
            ...
            this.checkValueEquality =
              options.checkValueEquality ||
              customUtils.defaultCheckValueEquality;
          }
        ...
        { "./bst": 16, "./customUtils": 17, underscore: 19, util: 3 },
      ],
      16: [
        function (require, module, exports) {
          /**
           ...
           */
          BinarySearchTree.prototype.checkAllNodesFullfillCondition = function (
            test
          ) {
            if (!this.hasOwnProperty("key")) {
              return;
           ...
           */
          BinarySearchTree.prototype.betweenBounds = function (
            query,
            lbm,
            ubm
          ) {
           ...
           */
          BinarySearchTree.prototype.prettyPrint = function (
            printData,
            spacing
          ) {
            spacing = spacing || "";
      ...
      17: [
        function (require, module, exports) {
          ...
          module.exports.defaultCompareKeysFunction =
...
*/
          (function () {
            ...
            define("promise/all", ["./utils", "exports"], function (
              __dependency1__,
              __exports__
            ) {
              "use strict";
    ...
    */
            ...
            define("promise/race", ["./utils", "exports"], function (
              __dependency1__,
              __exports__
            ) {
              "use strict";
                  ...
                  (function () {
                    ...
                    var driverSupport = (function (self) {
                      ...
                      result[DriverType.INDEXEDDB] = !!(function () {
                        ...
                        if (
                          typeof self.openDatabase !== "undefined" &&
                          self.navigator &&
                    ...
                    function isLibraryDriver(driverName) {
                      for (var driver in DriverType) {
                        if (
                          DriverType.hasOwnProperty(driver) &&
                    ...
                    var LocalForage = (function () {
                          ...
                          var promise = new Promise(function (resolve, reject) {
                            try {
                              ...
                              var namingError = new Error(
                                "Custom driver name already in use: " +
                                  driverObject._driver
                              );
                              ...
                              var customDriverMethods =
                                LibraryMethods.concat("_initStorage");
                              for (
                                var i = 0;
                                i < customDriverMethods.length;
                                i++
                              ) {
                      ...
                      LocalForage.prototype.getSerializer =
                        function getSerializer(callback) {
                          var serializerPromise = new Promise(function (
                            resolve,
                            reject
                          ) {
                    ...
                    function _checkBlobSupportWithoutCaching(idb) {
                      return new Promise(function (resolve, reject) {
                        ...
                        txn.oncomplete = function () {
                          ...
                          var blobTxn = idb.transaction(
                            [DETECT_BLOB_SUPPORT_STORE],
                            "readwrite"
                          );
                          var getBlobReq = blobTxn
                            .objectStore(DETECT_BLOB_SUPPORT_STORE)
                            .get("key");
                    ...
                    function _initStorage(options) {
                      ...
                      for (var j = 0; j < dbContext.forages.length; j++) {
                        ...
                        if (forage !== this) {
                          ...
                          readyPromises.push(
                            forage.ready()["catch"](ignoreErrors)
                          );
                        }
                      }
                    ...
                    function setItem(key, value, callback) {
                      ...
                      var promise = new Promise(function (resolve, reject) {
                        ...
                        self
                          ...
                          .then(function (value) {
                            var transaction = dbInfo.db.transaction(
                              dbInfo.storeName,
                              "readwrite"
                            );
                  ...
                  (function () {
                    ...
                    function keys(callback) {
                      ...
                      var promise = self.ready().then(function () {
                        ...
                        for (var i = 0; i < length; i++) {
                          if (
                            localStorage.key(i).indexOf(dbInfo.keyPrefix) === 0
                          ) {
                            keys.push(
                              localStorage
                                .key(i)
                      ...
                      if (
                        ...
                        if (value instanceof ArrayBuffer) {
                          ...
                          if (valueString === "[object Int8Array]") {
                            ...
                            valueString === "[object Uint8ClampedArray]"
                          ) {
                ...
                /***/ function (module, exports, __webpack_require__) {
                  ...
                  (function () {
                    ...
                    function _initStorage(options) {
                      ...
                      var dbInfoPromise = new Promise(function (
                        resolve,
                        reject
                      ) {
